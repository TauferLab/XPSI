...
def do_trials(rf, rf_1, rf_2, filename, labels_names_conf, names_conf, labels_names_type, names_type, num_trials=10) :
    train_errors = []
    test_errors = []
    psi_train_errors = []
    psi_test_errors = []
...
def save_trial(directory, train_errors, test_errors, train_accuracies_conf, test_accuracies_conf, train_accuracies_type, test_accuracies_type, psi_train_errors, psi_test_errors, train_ind, test_ind, predictions_real_test, confusionmatrix_test):
